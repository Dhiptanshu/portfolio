              ...
              return (
                ...
                >
                  <div className="w-full lg:w-3/5 group">
                    <div className="rpg-panel relative bg-muted overflow-hidden transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-[12px_12px_0px_hsl(var(--border))]">
                      {project.cover_image ? (
                        <img
                  ...
                  <div className="w-full lg:w-2/5 flex flex-col justify-center">
                    <h3 className="font-bold text-3xl md:text-4xl text-foreground mb-4">{project.title}</h3>
